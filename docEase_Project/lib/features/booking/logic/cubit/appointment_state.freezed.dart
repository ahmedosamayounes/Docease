...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AppointmentResponseModel appointmentResponseModel)?  success,TResult Function( String errorMessage)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.appointmentResponseModel);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AppointmentResponseModel appointmentResponseModel)  success,required TResult Function( String errorMessage)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.appointmentResponseModel);case Error():
return error(_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AppointmentResponseModel appointmentResponseModel)?  success,TResult? Function( String errorMessage)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Success implements AppointmentState {
  const Success(this.appointmentResponseModel);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.appointmentResponseModel, appointmentResponseModel) || other.appointmentResponseModel == appointmentResponseModel));
}


@override
int get hashCode => Object.hash(runtimeType,appointmentResponseModel);

@override
String toString() {
  return 'AppointmentState.success(appointmentResponseModel: $appointmentResponseModel)';
}
...
@useResult
$Res call({
 AppointmentResponseModel appointmentResponseModel
});
...
/// Create a copy of AppointmentState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? appointmentResponseModel = null,}) {
  return _then(Success(
null == appointmentResponseModel ? _self.appointmentResponseModel : appointmentResponseModel // ignore: cast_nullable_to_non_nullable
...
class Error implements AppointmentState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $AppointmentStateCopyWith<$Res> {
