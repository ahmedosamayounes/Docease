...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  specializationsLoading,TResult Function( SpecializationsResponseModel specializationResponseModel)?  specializationsSuccess,TResult Function( ErrorHandler errorHandler)?  specializationsError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return specializationsSuccess(_that.specializationResponseModel);case SpecializationsError() when specializationsError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  specializationsLoading,required TResult Function( SpecializationsResponseModel specializationResponseModel)  specializationsSuccess,required TResult Function( ErrorHandler errorHandler)  specializationsError,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case SpecializationsLoading():
return specializationsLoading();case SpecializationsSuccess():
return specializationsSuccess(_that.specializationResponseModel);case SpecializationsError():
return specializationsError(_that.errorHandler);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  specializationsLoading,TResult? Function( SpecializationsResponseModel specializationResponseModel)?  specializationsSuccess,TResult? Function( ErrorHandler errorHandler)?  specializationsError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case SpecializationsLoading() when specializationsLoading != null:
return specializationsLoading();case SpecializationsSuccess() when specializationsSuccess != null:
...
class SpecializationsSuccess implements HomeState {
  const SpecializationsSuccess(this.specializationResponseModel);
  

 final  SpecializationsResponseModel specializationResponseModel;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecializationsSuccess&&(identical(other.specializationResponseModel, specializationResponseModel) || other.specializationResponseModel == specializationResponseModel));
}
